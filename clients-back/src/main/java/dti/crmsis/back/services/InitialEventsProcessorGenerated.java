...
public class InitialEventsProcessorGenerated {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<ActivityEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toActivityEntity(node);
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RefActivityFieldEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRefActivityFieldEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<ActivityTypeEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toActivityTypeEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<CurrencieEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toCurrencieEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RefDealFieldEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRefDealFieldEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<DealEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toDealEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<LeadLabelEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toLeadLabelEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<LeadEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toLeadEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<NoteEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toNoteEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
   ...
   public void initRef_Organization_Fields() throws IOException {
        ...
        int entitiesCount = 0;
        while (true) {
            List<EventEntity> events = getEventEntities(pageIndex, pageSize, "REF_ORGANIZATION_FIELDS");
            if (events.isEmpty()) {
                break;
            }
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RefOrganizationFieldEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRefOrganizationFieldEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<OrganizationEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toOrganizationEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RefPersonFieldEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRefPersonFieldEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<PersonEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toPersonEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<PipelineEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toPipelineEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RefProductFieldEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRefProductFieldEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<ProductEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toProductEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<ProjectEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toProjectEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<RoleEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toRoleEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<StageEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toStageEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<TaskEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toTaskEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<UserEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toUserEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
        ...
        while (true) {
            ...
            for (EventEntity event : events) {
                ...
                if(jsonNode.get("success")!=null && jsonNode.get("success").asBoolean()){
                    ...
                    for (JsonNode node : jsonArray) {
                        entitiesCount++;
                        JsonToEntityServiceAnswer<WebhookEntity,PanacheEntityBase,PanacheEntityBase> answer = jsonService.toWebhookEntity(node);
                        entities.addAll(answer.getEntities());
                        customFields.addAll(answer.getCustomFieldEntities());
                        customFieldRefs.addAll(answer.getCustomFieldsRefs());
                    }
