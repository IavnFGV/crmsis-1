...
public class ClientDataExtractorServiceGenerated {
    ...
    private static final Logger logger =
            Logger.getLogger(ClientDataExtractorServiceGenerated.class);

    @Inject @RestClient PipedriveRestClientGeneratedV1 pipedriveRestClientGeneratedV1;

    @Inject @RestClient WebhooksRestClientV1 webhooksRestClientV1;

    @Inject PagingServiceV1 pagingServiceV1;
    ...
    protected void generateInitialEvents(
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getActivitiesAsJson(
                                                null,
                                                null,
                                                null,
        ...
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getActivityFieldsAsJson()),
                rootEventId,
                "REF_ACTIVITY_FIELDS");
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getActivityTypesAsJson()),
                rootEventId,
                "ACTIVITY_TYPES");
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getCurrenciesAsJson(null)),
                rootEventId,
                "CURRENCIES");
        pagingServiceV1.fetchAllDataNew(
                rootEventId,
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getDealFieldsAsJson(
                                                start, Constants.PAGE_LIMIT)),
                (String json, Long rootEvent) -> persistEvent(json, rootEvent, "REF_DEAL_FIELDS"));

        pagingServiceV2.fetchAllDataNew(
                rootEventId,
                (cursor) -> {
                    return wrapToRetry(
                            () ->
                                    pipedriveRestClientGeneratedV1.getDealsCollectionAsJson(
                                            cursor,
                                            Constants.PAGE_LIMIT,
                                            null,
                                            null,
        ...
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getLeadLabelsAsJson()),
                rootEventId,
                "LEAD_LABELS");
        pagingServiceV1.fetchAllDataNew(
                rootEventId,
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getLeadsAsJson(
                                                Constants.PAGE_LIMIT,
                                                start,
                                                null,
                                                null,
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getNotesAsJson(
                                                null,
                                                null,
                                                null,
                                                null,
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getOrganizationFieldsAsJson(
                                                start, Constants.PAGE_LIMIT)),
                (String json, Long rootEvent) ->
                        persistEvent(json, rootEvent, "REF_ORGANIZATION_FIELDS"));
        ...
        pagingServiceV2.fetchAllDataNew(
                ...
                (cursor) -> {
                    return wrapToRetry(
                            () ->
                                    pipedriveRestClientGeneratedV1.getOrganizationsCollectionAsJson(
                                            cursor, Constants.PAGE_LIMIT, null, null, null, null));
                },
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getPersonFieldsAsJson(
                                                start, Constants.PAGE_LIMIT)),
                (String json, Long rootEvent) ->
                        persistEvent(json, rootEvent, "REF_PERSON_FIELDS"));
        ...
        pagingServiceV2.fetchAllDataNew(
                ...
                (cursor) -> {
                    return wrapToRetry(
                            () ->
                                    pipedriveRestClientGeneratedV1.getPersonsCollectionAsJson(
                                            cursor, Constants.PAGE_LIMIT, null, null, null, null));
                },
                (json, rootEvent) -> persistEvent(json, rootEvent, "PERSONS"));
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getPipelinesAsJson()),
                rootEventId,
                "PIPELINES");
        pagingServiceV1.fetchAllDataNew(
                rootEventId,
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getProductFieldsAsJson(
                                                start, Constants.PAGE_LIMIT)),
                (String json, Long rootEvent) ->
                        persistEvent(json, rootEvent, "REF_PRODUCT_FIELDS"));
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getProductsAsJson(
                                                null,
                                                null,
                                                null,
                                                null,
        ...
        pagingServiceV2.fetchAllDataNew(
                ...
                (cursor) -> {
                    return wrapToRetry(
                            () ->
                                    pipedriveRestClientGeneratedV1.getProjectsAsJson(
                                            cursor, Constants.PAGE_LIMIT, null, null, null, null));
                },
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getRolesAsJson(
                                                start, Constants.PAGE_LIMIT)),
        ...
        pagingServiceV1.fetchAllDataNew(
                ...
                start ->
                        wrapToRetry(
                                () ->
                                        pipedriveRestClientGeneratedV1.getStagesAsJson(
                                                null, start, Constants.PAGE_LIMIT)),
        ...
        pagingServiceV2.fetchAllDataNew(
                ...
                (cursor) -> {
                    return wrapToRetry(
                            () ->
                                    pipedriveRestClientGeneratedV1.getTasksAsJson(
                                            cursor, Constants.PAGE_LIMIT, null, null, null, null));
                },
                (json, rootEvent) -> persistEvent(json, rootEvent, "TASKS"));
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getUsersAsJson()),
                rootEventId,
                "USERS");
        persistEvent(
                wrapToRetry(() -> pipedriveRestClientGeneratedV1.getWebhooksAsJson()),
                rootEventId,
                "WEBHOOKS");
    }
}
